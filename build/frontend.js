...
/* harmony import */ var platform__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! platform */ "./node_modules/platform/platform.js");
...
const Form = () => {
  const [username, setUsername] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("Testing_400415");
  const [password, setPassword] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("dowell123");
  ...
  const [islogIn, setLogIn] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    fetch("http://ip-api.com/json/?fields=61439").then(res => res.json()).then(data => {
      setIp(data.query);
  ...
  //OS
  const os = `${(platform__WEBPACK_IMPORTED_MODULE_2___default().os).family} ${(platform__WEBPACK_IMPORTED_MODULE_2___default().os).version}`;
  ...
  // user browser
  const browser = (platform__WEBPACK_IMPORTED_MODULE_2___default().name);
  ...
  const submitHandler = async event => {
    ...
    try {
      setDisabled(true);
      const response = await axios__WEBPACK_IMPORTED_MODULE_3__["default"].post(url, payloads);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, islogIn ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "you are login , welcome to Dowell uxliving lab ") : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("form", {
    onSubmit: submitHandler
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", null, " welcome back , please login into your account"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    name: "username",
    value: username,
    ...
    disabled: disabled
  }, "Log in")), islogIn && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    onClick: backHandler
  }, "back"));
};
...
function OurComponent(props) {
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Form__WEBPACK_IMPORTED_MODULE_4__["default"], null));
}
})();
